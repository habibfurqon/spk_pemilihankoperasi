...
<div class="card-body login-card-body">
    <h3 class="text-center" style="font-weight:bold">Log In</h3>
...
@error('email')
    ...
    <label for="remember" class="text" style="opacity: 0.75; font-size:12px">
    Selalu Ingat Saya
    </label>
    </div>
    </div>
...
<div class="row">
<div class="col-10">
<a href="{{route('register')}}" class="text-dark" style="font-size: 12px">Register</a>
</div>
<div class="col-2">
<a href="/" class="text-dark" style="font-size: 12px" >Home</a>
</div>
</div>
</div>
</div>
